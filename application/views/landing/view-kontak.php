...
<section class="single-page">
	...
	<section class="content content-white">
		<div class="container">
			<div class="row">
					<div class="col-md-12">
						<h2 class="title-content title-underline title-underline-invert font-black text-bold margin-top-no margin-bottom-lg">Hubungi kami</h2>
					</div>

					<div class="col-md-6">
						<h3>Bappeda Kabupaten Kediri</h3>
					...
					<div class="col-md-6">
						<h3>Jam Kerja</h3>
						 <i class="fa fa-clock-o fa-fw"></i> <b>Senin - Kamis</b> 08:00 - 16:00</br>
						<i class="fa fa-clock-o fa-fw"></i> <b>Jumat</b> 08:00 - 15:00</br>
						<i class="fa fa-clock-o fa-fw"></i> <b>Sabtu - Minggu</b> Libur</br>		
					</div>
