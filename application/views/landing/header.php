		...
		<?php if (isset($view_slide)) : ?>
			<section class="slider-main slider-large">
				<div id="slideshow" class="cycle-slideshow" data-cycle-tile-count="20" data-cycle-pause-on-hover="false" data-cycle-slides="> .slide" data-cycle-timeout="8000" data-cycle-speed="500">
					...
					<!-- UMKM uji coba -->
					<div class="slide" data-cycle-fx="tileBlind" style="background-image: url('<?php echo BASE_URL() ?>assets/smc/dist-landing/img/slider/umkm1.jpg')">
						<div class="container">
							<div class="caption">
								<div class="slider-caption-title font-ubuntu">
									UMKM Kediri
								</div>
								<div class="padding-top-md" style="padding:10px; background: rgba(255,255,255,0.6);margin-bottom: 10px;">UMKM Kabupaten Kediri dengan Produk Olahan Nanas</div>
							</div>
						</div>
					</div>

					<!-- bandara uji coba -->
					<div class="slide" data-cycle-fx="tileBlind" style="background-image: url('<?php echo BASE_URL() ?>assets/smc/dist-landing/img/slider/result-bandara.jpg')">
						<div class="container">
							<div class="caption">
								<div class="slider-caption-title font-ubuntu">
									Bandara Kabupaten Kediri
								</div>
								<div class="padding-top-md" style="padding:10px; background: rgba(255,255,255,0.6);margin-bottom: 10px;">Bandara Kabupaten Kediri terletak di wilayah barat sungai</div>
							</div>
						</div>
					</div>
					...
					<div class="slide" data-cycle-fx="tileBlind" style="background-image: url('<?php echo BASE_URL() ?>assets/smc/dist-landing/img/slider/background6-new.jpg')">
						<div class="container">
							<div class="caption">
								<div class="slider-caption-title font-ubuntu">
									Kabupaten Kediri
