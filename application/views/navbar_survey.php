    ...
    <ul class="nav navbar-nav side-nav">
        <li>
            <div class="profil-splash">
                <img src="<?php echo BASE_URL() . "assets/smc/dist/img/avatar.png"; ?>" alt="" width="50px">
                <div class="detail">
                    <h3>Surveyor
                        <br><small>Surveyor</small>
                    </h3>
                </div>
            </div>
        </li>
        ...
        <li class="active">
            <a href="javascript:;" data-toggle="collapse" data-target="#drop-sidebar" class="anchor-dropdown"><i class="fa fa-fw fa-clipboard"></i> Data Survei <i class="fa fa-angle-down pull-right"></i></a>
