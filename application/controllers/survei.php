...
class survei extends CI_Controller
{
    ...
    {
        $rekap = array(); /* PERTANIAN */
        $rekap["pertanian"] = array();
        ...
        $rekap["pertanian"][] = array("id" => "4", "elemen" => "Potensi Utama", "tahun" => $this->get_rekap_per_5th(), "child" => $child); /* PERKEBUNAN */
        $rekap["perkebunan"] = array();
        ...
        $rekap["perkebunan"][] = array("id" => "2", "elemen" => "Jumlah Produksi", "satuan" => "Ton", "tahun" => $this->get_rekap_per_5th("perkebunan", $_POST['kecamatan'], "Jumlah Produksi")); /* PETERNAKAN */
        $rekap["peternakan"] = array();
        $child = array();
        ...
        $rekap["peternakan"][] = array("id" => "1", "elemen" => "Jumlah Produksi", "tahun" => $this->get_rekap_per_5th(), "child" => $child); /* PERINAKAN */
        $rekap["perikanan"] = array();
    ...
    public function get_rekap_per_5th($unsur = null, $id_kecamatan = null, $param = null, $subparam = null, $subsubparam = null, $tahun = null)
    {
        ...
        for ($i = $tahun; $i > $tahun - 5; $i--) {
            switch ($param) {
                case 'Luas Lahan':
                    $result[$i] =  $this->m_survei->get_luas_lahan($i, $unsur, $id_kecamatan)->value;
                    break;
                case 'Padi 1x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_1x_setahun($i, $unsur, $id_kecamatan)->value;
                    break;
                case 'Padi 2x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_2x_setahun($i, $unsur, $id_kecamatan)->value;
                    break;
                case 'Padi 3x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_3x_setahun($i, $unsur, $id_kecamatan)->value;
                    break;
                case 'Nonpadi 1x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_1x_setahun($i, $unsur, $id_kecamatan, "nonpadi")->value;
                    break;
                case 'Nonpadi 2x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_2x_setahun($i, $unsur, $id_kecamatan, "nonpadi")->value;
                    break;
                case 'Nonpadi 3x Setahun':
                    $result[$i] =  $this->m_survei->get_tanam_3x_setahun($i, $unsur, $id_kecamatan, "nonpadi")->value;
                    break;
                case 'Jumlah Produksi':
                    $result[$i] =  $this->m_survei->get_jumlah_produksi($i, $unsur, $id_kecamatan)->value;
                    break;
                case 'Potensi Utama':
                    $result[$i] =  $this->m_survei->get_jumlah_potensi_utama($i, $unsur, $id_kecamatan, $subparam)->value;
                    break;
                case 'Jumlah Ternak':
                    $result[$i] =  $this->m_survei->get_jumlah_ternak($i, $unsur, $id_kecamatan, $subparam, $subsubparam)->value;
                    break;
                default:
                    $result[$i] = null;
                    break;
